...
object VerificationHelper {
    ...
    @JvmStatic
    private lateinit var verificationGeneratorProvider: VerificationGeneratorProvider
    @JvmStatic
    private lateinit var verificationValidateProvider: VerificationValidateProvider
    ...
    fun init(
        ...
        this.verificationGeneratorProvider = verificationGeneratorProvider
        this.verificationValidateProvider = verificationValidateProvider
        return this
    }
