...
class DefaultVerificationProvider : VerificationProvider {
    companion object {
        ...
        private val codeSequence = arrayOf("A", "B", "C", "D", "E", "F", "G", "H", "J", "K", "M", "N", "P", "Q", "R", "S", "T", "U", "V", "W", "X", "Y", "Z", "2", "3", "4", "5", "6", "7", "8", "9")
        ...
        private fun getFont(fontHeight: Int): Font? {
            val random = Random()
            val font = arrayOfNulls<Font>(1)
            ...
            font[0] = Font("Fixedsys", Font.BOLD, fontHeight)
    ...
    override fun render(): VerificationCode {
        ...
        return VerificationCode(randomCode.toString(), buffImg)
    }
}